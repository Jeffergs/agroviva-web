...
return (
    ...
    >
        ...
        <div className="d-flex justify-content-center">
            <a href="/fale" className="btn btn--primary px-4 py-2 fw-bold">
            Fale Conosco
            </a>
        </div>
        </div>
    ...
    <section id="cards" className="cards container py-5">
        ...
        <div className="col-12 col-md-6 col-lg-4">
            ...
            <p className="text-muted">
                Cultivamos propósito e impacto. Acreditamos que cada alimento pode
                transformar vidas e aproximar pessoas.
            </p>
        ...
        <div className="col-12 col-md-6 col-lg-4">
            ...
            <p className="text-muted">
                Plante, compartilhe e cresça com a gente. A AgroViva Web é o seu
                espaço para prosperar de forma colaborativa.
            </p>
